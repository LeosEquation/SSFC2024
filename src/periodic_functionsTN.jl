...
function Jacobian_Periodic_Orbits!(J::Matrix{Float64}, f!::Function, p, T::Float64, xs::Vector{Float64}, ps::Float64, Ts::Float64, sol::Vector{TaylorN{Float64}}, dx::Vector{Float64}, dx0::Vector{Float64}, zerosTN::Vector{Float64}, n::Int64)

    f!(dx, sol(zerosTN), p, T)
    ...
    for i in 1:n
        ...
        for j in 1:n
            ...
            J[i, j] = differentiate(sol[i], j)(zerosTN) - ==(i,j)

        end

        J[i, n+1]   = differentiate(sol[i], n+1)(zerosTN)
