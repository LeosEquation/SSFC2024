...
"""
    Derivative_IFT(f::Function, x::Float64, p::Float64, t::Float64)

Devuelve la derivada `∂x/∂p::Float64` de la función implícita de `f`
evaluada en `x` y `p`.
"""
...
"""
    Derivative_IFT(f::Function, x::Float64, p::Vector{Float64}, t::Float64, indice::Int64)
...
"""
    Derivative_IFT(f!::Function, x::Vector{Float64}, p::Float64, t::Float64)

Devuelve la derivada `∂x/∂p::Vector{Float64}` de la función implícita del sistema
...
"""
    Derivative_IFT(f!::Function, x::Vector{Float64}, p::Vector{Float64}, t::Float64, indice::Int64)
