...
$$ \vec{x} = \vec{x}\_{0} + \dot{G}(\vec{x}\_{0},\lambda\_{0})\Delta \vec{x} \Rightarrow \vec{x} - \vec{x}\_{0} = \dot{G}(\vec{x}\_{0},\lambda\_{0})\Delta \vec{x} $$

$$ \lambda = \lambda\_{0} + \dot{\lambda}(\vec{x}\_{0},\lambda_{0})\Delta \lambda \Rightarrow \lambda - \lambda\_{0} = \dot{\lambda}(\vec{x}\_{0},\lambda_{0})\Delta \lambda $$
